 ...
 */
class getCollectionWineRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CollectionWineRepository' shared autowired service.
     *
     * @return \App\Repository\CollectionWineRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CollectionWineRepository.php';

        return $container->privates['App\\Repository\\CollectionWineRepository'] = new \App\Repository\CollectionWineRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
