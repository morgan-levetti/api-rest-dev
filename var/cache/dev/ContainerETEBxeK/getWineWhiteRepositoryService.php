 ...
 */
class getWineWhiteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\WineWhiteRepository' shared autowired service.
     *
     * @return \App\Repository\WineWhiteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WineWhiteRepository.php';

        return $container->privates['App\\Repository\\WineWhiteRepository'] = new \App\Repository\WineWhiteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
